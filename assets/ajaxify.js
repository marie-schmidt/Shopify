...
var ajaxifyShopify = (function(module, $) {
    ...
    modalSetup = function () {
        ...
        $modalContainer.prepend('<button type="button" class="ajaxcart__close" title="' + "Close" + '">' + "Close" + '</button>');
    ...
    buildCart = function (cart) {
        ...
        if (cart.item_count === 0) {
            $cartContainer
                ...
                .append('<p class="text-center">' + "translation missing: en.cart.general.continue_browsing_html" + '</p>');
            switch (settings.method) {
                case 'modal':
                    sizeModal('resize');
                    break;
        ...
        $cartContainer.load(url, function() {
            ...
            switch (settings.method) {
                ...
                case 'drawer':
                    ...
                    $cartContainer.prepend('<button type="button" class="ajaxcart__close" title="' + "Close" + '">' + "Close" + '</button>');
                    $closeCart = $('.ajaxcart__close');
